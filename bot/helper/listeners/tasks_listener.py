...
class TaskListener(TaskConfig):
    ...
    async def onDownloadComplete(self):
        ...
        o_files, m_size = [], []
        TELEGRAM_LIMIT = 2097152000  # 2,000 MiB (2,097,152,000 bytes) as per Telegram/Pyrogram
        split_size = min(config_dict.get('LEECH_SPLIT_SIZE', TELEGRAM_LIMIT), TELEGRAM_LIMIT - 20 * 1024 * 1024)  # 2,076,180,480 bytes
